# Two-Factor Authentication Verification UI

## Overview
Implement the **Two-Factor Authentication Verification UI** task according to the specification below.

## Requirements
1. **Route `/auth-mfa-flow`**:
